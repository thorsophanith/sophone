  ...
  return (
    <div className='py-20'>
        ...
        <div data-aos='fade-left' data-aos-once='true' className='max-md:text-center'>
            ...
            <div id='dog2' className='py-10 md:py-4'><a href="" className='bg-blue-500 px-2 py-2 rounded-md font-medium text-white hover:bg-blue-400 duration-300'>Contact Us</a></div>
        </div>
    </div>
    </div>
  )
