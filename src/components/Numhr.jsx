    ...
    <div id='team' >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 place-items-center gap-10 max-w-7xl m-auto">
            ...
            <img  src={image1} alt="" class="w-[140px] md:w-[150px] h-[140px] md:h-[150px] p-4 rounded-full bg-white " />
                ...
                <p data-aos='fade-up'  data-aos-delay='300' class="text-xl text-gray-600">Digital Advertising</p>
                <p data-aos='fade-up'  data-aos-delay='600' class="mt-4"><a href="https://t.me/sophonspace" class="text-center border-2 border-sky-300 hover:bg-blue-500 hover:text-white duration-500 rounded-full px-5 py-2 text-gray-400">Contact Us</a></p>
            </div>
